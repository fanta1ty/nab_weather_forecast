...
internal enum FontFamily {
  ...
  internal enum Roboto {
    ...
    internal static let all: [FontConvertible] = [black, bold, boldItalic, italic, light, medium, regular]
  }
  internal static let allCustomFonts: [FontConvertible] = [Metropolis.all, Roboto.all].flatMap { $0 }
